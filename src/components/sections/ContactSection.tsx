...
const socials = [
  {
    label: 'Facebook',
    href: 'https://web.facebook.com/profile.php?id=61589067512542',
    icon: (
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/sanzoxofficial',
    icon: (
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/sanzox',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
